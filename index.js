...
server.post('/sendemail',async(req,res)=>{
    ...
    try{
        const transporter=nodemailer.createTransport({
            service:'gmail',
            auth:{
                user:"nkhomane237@gmail.com",
                pass:"clok qgqk tpld tele"
            }
        })
...
<body>
    <div class="container">
        ...
        <div class="mail-content">
            <p>Hello Neha ..!! I am <strong> ${fullName}</strong></p>
        ...
        <div class="footer">
        All rights reserved 2024 &copy by : Neha Khomane | Portfolio
        </div>
    </div>
            ...
            const mailOptions={
                from:"Resume Portfolio <nkhomane237@gmail.com>",
                to:'nkhomane237@gmail.com',
